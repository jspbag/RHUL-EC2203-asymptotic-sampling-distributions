...
- The **Central Limit Theorem (CLT)** states conditions such that the distribution of $\sqrt{n}(\overline{Y} - \mu_Y)/\sigma_Y$ is very close to the standard normal distribution when $n$ is large
